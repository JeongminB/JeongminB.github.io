...
score는 각 단어의 중요도와도 같습니다. 벡터 간 cosine이나, $\mathbf h_t^{\mathsf T} \mathbf W \bar {\mathbf h}_s$ 처럼 bilinear 연산을 통해 학습하는 일반적인 방법도 있지만 (Luong's style), 가장 간단한 방법은 두 벡터간 내적이 아닌가 싶습니다.
